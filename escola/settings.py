...
SECRET_KEY = 'django-insecure-$+ngo*3f3t5yf+knbde7r#du$=)=^)4(029)=yu#yj(98$)euk'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_CLASSES': (
        ...
        'rest_framework.throttling.UserRateThrottle',   # User registered
    ),
    # Limits of requisitions by specfic time
